...
class Inventor_Favorites_Logic {
    ...
    public static function init() {
        ...
        add_action( 'inventor_listing_banner_actions', array( __CLASS__, 'render_favorite_button' ), 1, 1 );
    ...
    public static function remove_favorite() {
        ...
        if( ! is_user_logged_in() ) {
            $data = array(
                'success' => false,
                'message' => __( 'Please login to remove favorite.', 'inventor-favorites' ),
            );
    ...
    public static function add_favorite() {
        ...
        if( ! is_user_logged_in() ) {
            $data = array(
                'success' => false,
                'message' => __( 'Please login to add a favorite.', 'inventor-favorites' ),
            );
        } else if ( ! empty( $_GET['id'] ) ) {
