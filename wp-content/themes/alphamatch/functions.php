...
function superlist_enqueue_files() {
	...
	wp_enqueue_style( 'superlist', get_template_directory_uri() . '/assets/css/' . $style, array(), '20170626' );
	wp_enqueue_style( 'style', get_stylesheet_directory_uri() . '/style.css', '20170626' );
