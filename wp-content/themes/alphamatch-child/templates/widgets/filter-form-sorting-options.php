<div class="filter-sorting-options clearfix">
    <div class="filter-sorting-inner">
        ...
        <div class="filter-sorting-inner-styles">
            <button type="button" onclick="location.href='<?php bloginfo( 'url' ); ?>/add-listing';" class="button btn bnt-lg btn-primary filter-create-listing"><i class="fa fa-plus"></i> Create Listing</button>
        </div>
